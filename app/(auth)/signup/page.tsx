    ...
    <div className="flex min-h-screen">
      ...
      <div className="flex flex-1 flex-col justify-center px-8 py-12 sm:px-16 lg:px-24">
        <div className="mx-auto w-full max-w-md">
          ...
          {/* Name / Email / Password form with client-side validation */}
      ...
      <div className="hidden flex-1 items-center border-l border-gray-200 bg-gray-50 px-16 lg:flex">
        <div className="max-w-lg">
          <h2 className="mb-4 text-2xl font-semibold leading-snug text-gray-900 sm:text-3xl">
            Stop reading entire documents. Start uncovering what matters.
          </h2>
          <p className="mb-6 text-base leading-relaxed text-gray-600">
            UnderstandPDF extracts key insights from any document, highlights
            source citations, and suggests new research directions — perfect for
            students, researchers, and anyone who needs to quickly grasp what a
            document is really saying.
          </p>
